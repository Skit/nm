all_langs = {
    'ru': {
        ...
        " or have an offer.": "Привет, $name!\n\n«Не забудь закупиться полезными вкусняшками по доступным ценам с "
                              "ежедневными напоминаниями о рынках Алании»\nТвой проводник — nomad_bazaar.\n\nПо всем "
                              "вопросам, предложениям и найденным ошибкам пиши на nomadbazaar.bot@gmail.com",
    }
}
